...
set_hitbox_value(AT_FSPECIAL, 1, HG_EFFECT, 3);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, HFX_ZET_FIRE_BIG)
set_hitbox_value(AT_FSPECIAL, 1, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_flame"));
