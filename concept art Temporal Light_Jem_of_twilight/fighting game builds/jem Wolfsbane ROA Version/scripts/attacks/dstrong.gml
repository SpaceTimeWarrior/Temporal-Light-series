...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, .2);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_ghost_glove"));
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX_FRAME, 0);


set_window_value(AT_DSTRONG, 2, AG_WINDOW_TYPE, 2);
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_INVINCIBILITY, 2);


set_window_value(AT_DSTRONG, 3, AG_WINDOW_TYPE, 3);
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ori_dspecial_bash_miss"));
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX_FRAME, 0);


set_window_value(AT_DSTRONG, 4, AG_WINDOW_TYPE, 2);
set_window_value(AT_DSTRONG, 4, AG_WINDOW_LENGTH, 60);
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_ori_bash_hit"));
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX, asset_get("sfx_ori_bash_launch"));
...
set_hitbox_value(temp_attack, temp_num, HG_HIT_SFX, asset_get("sfx_ghost_glove"));
